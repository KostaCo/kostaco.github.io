...
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    \item Analiza efikasnosti reprezentacije podataka kroz asimptotski dokaz teorijske optimalnosti baze $e$.
    \item Matematičko opravdanje praktične superiornosti ternarnog sistema (baza 3) uz prikaz primene u računarskoj arhitekturi i teoriji fraktala.
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    \item Interaktivna platforma za vizuelizaciju i mapiranje istorijskih, naučnih i filozofskih događaja.
    \item Razvijeno korišćenjem modernih web tehnologija sa naglaskom na čist dizajn i intuitivan UI.
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    ...
    \item Istorijska retrospektiva razvoja računarskih nauka i kritička analiza etičkih i filozofskih implikacija budućeg razvoja veštačke inteligencije.
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em, topsep=2ex, itemsep=0.3ex]
    \item \textbf{Programski jezici:} C, C++, C\#, Python, ARM64 Assembly, x86-64 Assembly, JavaScript, MATLAB, Unity
    \item \textbf{Operativni sistemi i alati:} Linux, Git, \LaTeX, HTML, CSS
