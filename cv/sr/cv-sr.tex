...
% --- OBRAZOVANJE ---
\section*{Obrazovanje}
\entry{Fizički fakultet, Univerzitet u Beogradu}{od oktobra 2026.}{Student osnovnih akademskih studija, smer \textbf{Teorijska i eksperimentalna fizika}}{}

\entry{Matematički fakultet, Univerzitet u Beogradu}{2025 -- danas}{Student osnovnih akademskih studija, smer \textbf{Informatika}}{}
...
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    ...
    \item Član sekcije primenjene fizike i elektronike (PFE)
\end{itemize}
...
\entry{Ekonomija baze: Odabir optimalne osnove brojevnog sistema i primene}{2026.}{}{Istraživački rad}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
...
\entry{Contextual Timeline}{2026.}{}{Web alat}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
...
\entry{AI u astronomiji: Otkrivanje egzoplaneta i obrada svemirskih podataka}{2026.}{}{Istraživački rad}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
...
\entry{Nadgledano mašinsko učenje}{2024--2025.}{}{Istraživački rad}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
...
\entry{AstroJump}{2023.}{}{Video-igra}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
...
\end{itemize}
\entry{Privatni mentor za matematiku i fiziku}{2021--2025.}{Samostalni pedagoški rad}{}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    \item Individualna nastava i priprema učenika osnovnih i srednjih škola.
    \item Razvoj prilagođenih metodologija podučavanja i vizuelizacije apstraktnih koncepata, uz podsticanje logičkog razmišljanja i samostalnog rešavanja problema kod učenika.
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em, topsep=2ex, itemsep=0.3ex]
    ...
    \item \textbf{Strani jezici:} Srpski (maternji), Engleski (CAE C2), Nemački (osnovni nivo), Latinski (osnovni nivo)
\end{itemize}


\vspace{2ex}
% --- SEMINARI ---
\section*{Seminari i stručno usavršavanje}
\entry{Seminar o generativnim AI modelima i sintezi slika}{2023.}{Ambasada Republike Turske u Beogradu}{}
\begin{itemize}[leftmargin=1.5em, topsep=0.2ex, itemsep=0.2ex]
    \item Stručni seminar posvećen teorijskim osnovama difuzionih modela, neuronskih mreža za generisanje vizuelnog sadržaja i praktičnoj primeni generativne veštačke inteligencije.
\end{itemize}
...
% --- VANAKADEMSKA INTERESOVANJA ---
\section*{Vanakademska interesovanja}
\vspace{1ex}
\begin{itemize}[leftmargin=1.5em, topsep=0.8ex, itemsep=0.3ex]
    \item \textbf{Filozofija}
    \item \textbf{Klasična književnost}
    \item \textbf{Samostalni inženjerski projekti (3D printing, elektronika)}
    \item \textbf{Istorija}
    \item \textbf{Muzika}
\end{itemize}
